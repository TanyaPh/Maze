...
//        MazeController mazeController(numRows, numCols);

//        // Generate and save a maze
//        mazeController.generateMaze();
//        mazeController.saveMatrixToFile("awd.txt");
//        Matrix myMatrix = mazeController.getMatrix();
...
//        std::pair<int, int> dest(0, numCols - 1);
//        mazeController.solveMaze(src, dest);
